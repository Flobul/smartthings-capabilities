<?php return array (
  ...
  "filterState" => 
  array (
    "supportedFilterCommands" => __("supportedFilterCommands", __FILE__),
    "resetFilter" => __("resetFilter", __FILE__),
  ),
  "firmwareUpdate" => 
  array (
  ...
  "lock" => 
  array (
    "supportedUnlockDirections" => __("supportedUnlockDirections", __FILE__),
  ),
  "samsungTV" => 
  array (
