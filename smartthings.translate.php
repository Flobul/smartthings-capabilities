    ...
    public function __construct()
    {
        $this->enums = [
            ...
            "event" => [
                ...
                "keepWarmComplete"     => __("Maintien au chaud terminé", __FILE__),
                "reheatingComplete"    => __("Réchauffage terminé", __FILE__),
                "autoCleanComplete"    => __("Auto-nettoyage terminé", __FILE__),
                "soakInnerPotComplete" => __("Trempage dans le pot intérieur terminé", __FILE__),
                "steamEmission"        => __("Émission de vapeur", __FILE__)
            ],
            ...
            "menu" => [
                "stickyPlainRice" => __("Riz nature collant", __FILE__),
                "wellCookedPlainRice" => __("Riz nature bien cuit", __FILE__),
                "frozenPlainRice" => __("Riz surgelé", __FILE__),
                "mixedGrains" => __("Céréales mélangées", __FILE__),
                "brownRice100" => __("Riz brun 100", __FILE__),
                "riceWithBeans" => __("Riz aux haricots", __FILE__),
                "barleyMixedGrainRice" => __("Orge riz à grains mélangés", __FILE__),
                "superGrains" => __("Super grains", __FILE__),
                "frozenMixedGrain" => __("Céréales mélangées surgelées", __FILE__),
                "cauldronRice" => __("Riz au chaudron", __FILE__),
                "riceForGimbap" => __("Riz pour gimbap", __FILE__),
                "plainQuick" => __("Simple et rapide", __FILE__),
                "konjacRice" => __("Riz au konjac", __FILE__),
                "mixedGrainForSalad" => __("Céréales mélangées pour salade", __FILE__),
                "mixedGrainsQuick" => __("Grains mélangés rapide", __FILE__),
                "nutritiousRiceInHotPot" => __("Riz nutritif dans une marmite chaude", __FILE__),
                "steamedDish" => __("Plat à la vapeur", __FILE__),
                "nutritiousPorridge" => __("Bouillie nutritive", __FILE__),
                "scorchedRiceTea" => __("Thé au riz brûlé", __FILE__),
                "bakedEgg" => __("Œuf cuit au four", __FILE__),
                "sousVide" => __("Sous vide", __FILE__),
                "scorchedRice" => __("Riz brûlé", __FILE__),
                "babyFoodStep1" => __("Alimentation pour bébé étape 1", __FILE__),
                "babyFoodStep2" => __("Alimentation pour bébé étape 2", __FILE__),
                "babyFoodStep3" => __("Alimentation pour bébé étape 3", __FILE__),
                "riceWithSeasonedVegetablesInHotPot" => __("Riz avec légumes assaisonnés dans une marmite chaude", __FILE__),
                "mixedGrainForSlim" => __("Céréales mixtes pour minceur", __FILE__),
                "mixedGrainForVitality" => __("Céréales mixtes pour la vitalité", __FILE__),
                "haedeul" => __("Haedeul", __FILE__),
                "alchanmi" => __("Alchanmi", __FILE__),
                "odaemi" => __("Odaemi", __FILE__),
                "oatRice" => __("Riz à l'avoine", __FILE__),
                "chickpeaRice" => __("Riz aux pois chiches", __FILE__),
                "quinoaRice" => __("Riz au quinoa", __FILE__),
                "lentilBeanRice" => __("Riz aux lentilles et aux haricots", __FILE__),
                "steamedSweetPotato" => __("Patate douce à la vapeur", __FILE__),
                "galbijjim" => __("Galbijjim", __FILE__),
                "samgyetang" => __("Samgyetang", __FILE__),
                "riceWithWebfootOctopusAndSaussureaInHotPot" => __("Riz au pied de biche, poulpe et saussure dans une marmite chaude", __FILE__),
                "riceWithAbaloneInHotPot" => __("Riz à l'orpin dans une marmite chaude", __FILE__),
                "riceWithTruffledBulgogiInHotPot" => __("Riz avec bulgogi truffé dans une marmite chaude", __FILE__),
                "riceWithSteakInHotPot" => __("Riz avec steak dans une marmite chaude", __FILE__),
                "riceWithRipeKimchiAndAbaloneInHotPot" => __("Riz avec kimchi mûr et ormeau dans un pot chaud", __FILE__),
                "riceWithBeefAndBeanSproutsInHotPot" => __("Riz au boeuf et aux pousses de haricots dans une marmite chaude", __FILE__),
                "riceWithAssortedMushrommsInHotPot" => __("Riz avec assortiment de champignons dans une marmite chaude", __FILE__),
                "riceWithBrackenAndSteakInHotPot" => __("Riz au cracken et steak dans une marmite chaude", __FILE__),
                "riceWithBeefAndAssortedMushroomsInHotPot" => __("Riz au boeuf et champignons variés dans une marmite chaude", __FILE__),
                "riceWithSpicyWebfootOctopusInHotPot" => __("Riz avec poulpe épicé dans une marmite chaude", __FILE__),
                "kamutRice" => __("Riz kamut", __FILE__),
                "mixedGrainForSaladWithLentilBean" => __("Céréales mélangées pour salade avec lentilles", __FILE__),
                "mixedGrainForSaladWithChickpea(1Cup)" => __("Céréales mélangées pour salade avec pois chiches (1 part)", __FILE__),
                "mixedGrainForSaladWithQuinoa" => __("Céréales mélangées pour salade avec quinoa", __FILE__),
                "mixedGrainForSaladWithMillet" => __("Céréales mélangées pour salade avec du millet", __FILE__),
                "mixedGrainForSaladWithChickpea(2Cup)" => __("Céréales mélangées pour salade avec pois chiches (2 parts)", __FILE__),
                "mixedGrainForSaladWithBarley" => __("Céréales mélangées pour salade avec orge", __FILE__),
                "mixedGrainForSaladWithBrownRice(1Cup)" => __("Céréales mélangées pour salade avec riz brun (1 part)", __FILE__),
                "mixedGrainForSaladWithOatRice" => __("Céréales mélangées pour salade avec riz à l'avoine", __FILE__),
                "mixedGrainForSaladWithBrownRice(2Cup)" => __("Céréales mélangées pour salade avec riz brun (2 parts)", __FILE__),
                "mixedGrainForSaladWithKamut" => __("Céréales mélangées pour salade avec kamut", __FILE__),
                "mixedGrainForSaladWithBrownRice" => __("Céréales mélangées pour salade avec riz brun", __FILE__),
                "mixedGrainForSaladWithQuinoa(1Cup)" => __("Céréales mélangées pour salade avec quinoa (1 part)", __FILE__),
                "mixedGrainForSaladWithChickpea" => __("Céréales mélangées pour salade avec pois chiches", __FILE__),
                "mixedGrainForSaladWithQuinoa(2Cup)" => __("Céréales mélangées pour salade avec quinoa (2 parts)", __FILE__),
                "mixedGrainForSaladWithAdlay" => __("Céréales mélangées pour salade avec tapis", __FILE__),
                ...
                "abalonePorridge" => __("Porridge d'ormeaux", __FILE__),
                "pineNutPorridge" => __("Porridge aux pignons de pin", __FILE__),
                "boiledEgg" => __("Œuf cuit", __FILE__),
                ...
                "broccoliPorridge" => __("Porridge aux brocolis", __FILE__),
                "potatoCarrotPorridge" => __("Porridge de pommes de terre et de carottes", __FILE__),
        ...
        $this->cmdName = [
            ...
            "remoteControlStatus" => [
                "remoteControlEnabled" => __("Contrôle intelligent", __FILE__)
            ],
            "riceCooker" => [
                "completionTime"       => __("Heure de fin",__FILE__),
