<?php return array (
  ...
  array (
    ...
    "running" => __("running", __FILE__),
    "stopped" => __("stopped", __FILE__),
  ),
  "chargingState" => 
  array (
    "other" => __("Other", __FILE__),
  ),
  "coffeeMakerOperationStatus" => 
  array (
    "initializing" => __("initializing", __FILE__),
    "ready" => __("ready", __FILE__),
    "making" => __("making", __FILE__),
    "complete" => __("complete", __FILE__),
  ...
  "dishwasherMode" => 
  array (
    "smart" => __("Smart", __FILE__),
    "daily" => __("Daily", __FILE__),
    "superClean" => __("SuperClean", __FILE__),
    "brightening" => __("Brightening", __FILE__),
    "prewash" => __("Prewash", __FILE__),
  ),
  "mode" => 
  array (
    "preset1" => __("Ma trousse", __FILE__),
    ...
    "noMode" => __("noMode", __FILE__),
  ),
  "ovenMode" => 
  array (
    "StrongSteam" => __("Strong Steam", __FILE__),
  ...
  "operatingState" => 
  array (
    "sabbath" => __("sabbath", __FILE__),
    "suspend" => __("suspend", __FILE__),
  ),
  "cycleType" => 
  array (
    "allInOne" => __("allInOne", __FILE__),
    "washingOnly" => __("washingOnly", __FILE__),
    "dryingOnly" => __("dryingOnly", __FILE__),
  ),
  "protocolType" => 
  array (
