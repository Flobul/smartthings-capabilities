<?php return array (
  ...
  array (
    ...
    "drainingWater" => __("drainingWater", __FILE__),
    "waitingForDescaling" => __("waitingForDescaling", __FILE__),
  ),
  "deodorFilterStatus" => 
  array (
  ...
  array (
    "dryingautoreleasedelay" => __("dryingautoreleasedelay", __FILE__),
  ),
  ...
  "steamClosetJobState" => 
  array (
    "descaling" => __("descaling", __FILE__),
    "descalingFinish" => __("descalingFinish", __FILE__),
  ),
  "homingReason" => 
  array (
    "supplyingWater" => __("supplyingWater", __FILE__),
  ),
  "washerJobPhase" => 
  array (
